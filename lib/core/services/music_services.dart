...
class MusicOperation {
  ...
  static List<Music> getMusics(){
    return <Music>[
      ...
      Music(name:'Levitating', imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRcllK9c-asQ_GMB_ylfo0wcFT-jFEPxeJm9g&s', desc: 'Dua Lipa', audioUrl: 'https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/d6/87/41/d687410c-4714-af1d-e055-3296d4777226/mzaf_16921438337215363475.plus.aac.p.m4a'),
